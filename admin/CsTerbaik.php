...
include "navbarsql.php";
     ...
     $query_1 = $con->query("SELECT score FROM csterbaik where id = 1 ");
     $action_1 = $query_1->fetch_assoc();
     $score_1 = "".$action_1["score"]."";

     $query_2 = $con->query("SELECT score FROM csterbaik where id = 2 ");
     $action_2 = $query_2->fetch_assoc();
     $score_2 = "".$action_2["score"]."";

     $query_3 = $con->query("SELECT score FROM csterbaik where id = 3 ");
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['2018', 'Dadan Suherman' , 'Erwin Erdiansyah', 'Santana Toperson'],
          ['CS Terbaik', <?php echo $score_1; ?> , <?php echo $score_2; ?>, <?php echo $score_3; ?>]
        ]);

        var options = {
          chart: {
            title: 'Hasil Vote Nominasi CS Terbaik',
            subtitle: '',
          }
        };

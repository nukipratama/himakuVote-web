...
include "navbarsql.php";
     ...
     $query_1 = $con->query("SELECT score FROM dosenterbaik where id = 1 ");
     $action_1 = $query_1->fetch_assoc();
     $score_1 = "".$action_1["score"]."";

     $query_2 = $con->query("SELECT score FROM dosenterbaik where id = 2 ");
     $action_2 = $query_2->fetch_assoc();
     $score_2 = "".$action_2["score"]."";

     $query_3 = $con->query("SELECT score FROM dosenterbaik where id = 3 ");
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['2018', 'Sri Rahayu, S.E., M.Ak., Ak., CA.' , 'Vaya Juliana Dillak, S.E., M.M', 'Kurnia, S.AB., M.M.'],
          ['Dosen Terbaik', <?php echo $score_1; ?> , <?php echo $score_2; ?>, <?php echo $score_3; ?> ]
        ]);

        var options = {
          chart: {
            title: 'Hasil Vote Nominasi Dosen Terbaik',
            subtitle: '',
          }
        };

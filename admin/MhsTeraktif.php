...
include "navbarsql.php";
     ...
     $query_1 = $con->query("SELECT score FROM mhsteraktif where id = 1 ");
     $action_1 = $query_1->fetch_assoc();
     $score_1 = "".$action_1["score"]."";

     $query_2 = $con->query("SELECT score FROM mhsteraktif where id = 2 ");
     $action_2 = $query_2->fetch_assoc();
     $score_2 = "".$action_2["score"]."";

     $query_3 = $con->query("SELECT score FROM mhsteraktif where id = 3 ");
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['2018', 'Iqbal Fadly' , 'Nabila Aldama', 'Fadel Variza'],
          ['Mahasiswa Teraktif', <?php echo $score_1; ?> , <?php echo $score_2; ?>, <?php echo $score_3; ?>]
        ]);

        var options = {
          chart: {
            title: 'Hasil Vote Nominasi Mahasiswa Teraktif',
            subtitle: '',
          }
        };
